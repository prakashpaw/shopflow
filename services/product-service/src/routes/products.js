...
// Admin route to add new products (handles multipart/form-data)
router.post('/', upload.single('imageFile'), (req, res) => {
    ...
    if (req.file) {
        // We route products via NGINX proxy so the local backend is served at root
        imageUrl = `http://localhost:8080/products/uploads/${req.file.filename}`;
    }
